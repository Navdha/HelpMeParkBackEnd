...
public class GarageC {
    public static void main(String[] args) throws IOException {
	     ...
	     * listening on port 6764.  When a connection is requested, it
	...
	int clientNumber = 0;
	ServerSocket listener = new ServerSocket(6764);
	try {
	    while (true) {
	...
	public void run() {
		...
		Document doc = Jsoup.connect("http://parkpgh.org/lots/39").get();
