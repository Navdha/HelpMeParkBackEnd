...
public class GarageB {
	...
	/**
	     ...
	     * listening on port 6763.  When a connection is requested, it
	...
	int clientNumber = 0;
	ServerSocket listener = new ServerSocket(6763);
	try {
	    while (true) {
	...
	public void run() {
		...
		Document doc = Jsoup.connect("http://parkpgh.org/lots/2").get();
